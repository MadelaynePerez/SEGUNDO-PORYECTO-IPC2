...
public class ClienteServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            usuario.setRol(new Rol(1, "Cliente"));
            ...
            boolean resultado = new ClienteService().crearCliente(usuario, cliente);

            if (resultado) {
                JsonUtil<String> mensajeJson = new JsonUtil<>();
                mensajeJson.EnviarJson(response, "cliente Creado");
            } else {
                JsonUtil<String> mensajeJson = new JsonUtil<>();
                mensajeJson.EnviarJson(response, "error al crear cliente");
            }
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         try {
            ...
            boolean resultado = new ClienteService().modificarCliente(usuario, cliente);

            if (resultado) {
                JsonUtil<String> mensajeJson = new JsonUtil<>();
                mensajeJson.EnviarJson(response, "cliente actualizado");
            } else {
                JsonUtil<String> mensajeJson = new JsonUtil<>();
                mensajeJson.EnviarJson(response, "error al actualizar cliente");
            }
